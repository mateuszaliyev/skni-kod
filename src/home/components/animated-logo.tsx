    ...
    >
      ...
      <g stroke={`url(#${gradientId})`}>
        ...
        <path
          ...
          style={
            {
              "--path-length": rightBracketRef.current?.getTotalLength(),
            } as CSSProperties
          }
        />
      </g>
