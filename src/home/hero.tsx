...
import { ButtonGradientLink, ButtonLink } from "@/components/button";
...
export const Hero = () => {
  return (
    <section className="relative h-screen min-h-[640px] lg:min-h-[768px]">
      <IsometricPrismCanvasBackground className="absolute inset-0" />
      ...
      <div className="absolute inset-0 pt-20">
        <div className={cx(CONTAINER_STYLES, "flex h-full items-center")}>
          <div className="flex basis-full flex-col items-center xl:basis-1/2 xl:items-start">
            <h1 className="select-none text-center text-6xl font-thin sm:text-8xl md:text-9xl xl:text-left">
              Tworzymy
              <Barrel
            ...
            <div className="flex flex-col items-center gap-12 sm:flex-row">
              <ButtonGradientLink href="#">Dołącz do nas</ButtonGradientLink>
          ...
          <IsometricPrismCanvasLogo
            ...
            className="ml-auto hidden h-[449px] w-[480px] xl:block"
            size={40}
          />
